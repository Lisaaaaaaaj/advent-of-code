...
const findCorrectUpdatesInOrder = () => {
...
const foundCorrectUpdatesInOrder = findCorrectUpdatesInOrder();
const sumOfMiddlePageNumbers = foundCorrectUpdatesInOrder.reduce(
